        ...
        <main className="md:ml-[280px] w-full p-4 md:p-10 bg-[#F4F0EA] relative" style={{ backgroundImage: 'radial-gradient(#000 1px, transparent 1px)', backgroundSize: '20px 20px' }}>
          <div className="max-w-5xl mx-auto space-y-8 md:space-y-16">
            ...
            <section className="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-6 md:p-12">
              ...
              <div className="mb-12 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] bg-black">
                <CodeBlock language="html" code={fullHtmlCode} />
              </div>
              ...
              <div className="mb-16 bg-white border-4 border-black p-6 md:p-10 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center relative overflow-hidden">
                 ...
                 <div className="border-4 border-dashed border-black bg-[#F4F0EA] min-h-[400px] flex items-center justify-center relative group overflow-hidden">
                    ...
                    {/* <img src="/gambar-hasil-project1.png" alt="Hasil Render HTML" className="w-full h-auto object-cover relative z-10" /> */}
                    {/* ========================= */}

                    <div className="absolute inset-0 flex flex-col items-center justify-center text-black/40 group-hover:text-black/70 transition-colors z-0">
                      <span className="material-symbols-outlined text-6xl mb-2">add_photo_alternate</span>
                      <p className="font-black uppercase tracking-widest text-xl">[TEMPAT MASUKAN GAMBAR]</p>
                      <p className="font-bold text-sm mt-2">Buka file <code>project-1/page.tsx</code> dan uncomment tag <code>&lt;img&gt;</code> di bagian ini.</p>
                    </div>
                 </div>
              </div>
