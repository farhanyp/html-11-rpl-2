          ...
          <div className="max-w-5xl mx-auto space-y-12 md:space-y-16">
            ...
            <section className="bg-pine-deep border-4 border-black p-6 md:p-12 shadow-neo-xl text-center relative overflow-hidden text-white">
              ...
              <div className="relative z-10 pt-8">
                <h1 className="text-4xl sm:text-5xl md:text-7xl font-black text-mint-soft tracking-tighter uppercase mb-4 md:mb-6 drop-shadow-[4px_4px_0px_rgba(255,255,255,0.2)]">
                  Advanced Query: <br className="hidden md:block" /> Master Filter Data
                </h1>
                <p className="text-base md:text-xl font-bold text-black bg-white inline-block px-4 py-2 md:px-6 md:py-3 border-4 border-black mb-8 md:mb-10 shadow-neo-md uppercase tracking-tight">
                  Berhenti memanggil semua data. Mulailah menyortir layaknya profesional!
                </p>
                <div>
                  <button
                  ...
                  >
                    {isHacking ? (
                      <><span>Sedang Memfilter...</span> <span className="material-symbols-outlined font-black text-4xl animate-spin">sync</span></>
                    ) : (
                      <><span>Aktifkan Filter</span> <span className="material-symbols-outlined font-black text-4xl">filter_alt</span></>
                    )}
                  </button>
                </div>
              </div>
            ...
            <section className="bg-white border-4 border-black shadow-neo-xl p-6 md:p-12 rotate-1 hover:rotate-0 transition-transform">
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-black uppercase mb-8 md:mb-10 border-b-4 border-black pb-4 flex items-center gap-3 md:gap-4 tracking-tighter">
                ...
                Multi-Insert (Jurus Combo)
              </h2>

              <div className="flex flex-col lg:flex-row gap-8 items-stretch">
                <div className="flex-1 space-y-6">
                  <p className="text-lg md:text-xl font-bold text-forest-teal leading-relaxed">
                    Kalau kamu harus memasukkan 100 murid baru, apakah kamu akan mengetik perintah <code>INSERT INTO</code> 100 kali? <strong>Tentu tidak!</strong>
                  </p>
                  <p className="text-lg md:text-xl font-bold text-forest-teal leading-relaxed">
                    Kamu bisa melakukan <em>combo</em> alias memasukkan banyak data sekaligus hanya dengan sekali ketik.
                  </p>
                </div>
                ...
                <div className="lg:w-1/2 bg-black text-white font-mono p-6 border-4 border-black shadow-neo-md transform -rotate-1">
                  ...
                  &nbsp;&nbsp;(<span className="text-jade-vibrant">'Andi'</span>), <span className="text-gray-500">{"// Koma untuk memisah"}</span> <br/>
                  &nbsp;&nbsp;(<span className="text-jade-vibrant">'Budi'</span>),<br/>
                  &nbsp;&nbsp;(<span className="text-jade-vibrant">'Citra'</span>)<span className="text-yellow-400">;</span> <span className="text-gray-500">{"// Titik koma di akhir"}</span>
                </div>
              </div>
            </section>
            ...
            <section className="bg-mint-soft border-4 border-black shadow-neo-xl p-6 md:p-12 -rotate-1 hover:rotate-0 transition-transform">
              ...
              <div className="flex flex-col lg:flex-row gap-8 items-center">
                <div className="lg:w-1/3 bg-white border-4 border-black shadow-neo-md p-6 text-center transform rotate-2">
                  ...
                  <p className="font-black uppercase text-2xl text-black mb-2">Keyword "%"</p>
                  <p className="font-bold text-forest-teal text-sm">Persen artinya "Bebas ada huruf apa saja di posisi ini".</p>
                </div>

                <div className="flex-1 space-y-6">
                  <p className="text-lg md:text-xl font-bold text-black leading-relaxed">
                    Bagaimana Google bisa menemukan namamu walau hanya diketik separuh? Database menggunakan perintah <code className="bg-black text-white px-2 uppercase">LIKE</code>.
                  </p>
                  ...
                  <div className="bg-white p-4 border-4 border-black font-bold text-forest-teal">
                    Contoh di atas akan memunculkan: "<strong>Budi</strong>nto", "Setia <strong>Budi</strong>", atau "Slamet <strong>Budi</strong>man". Selama ada kata "Budi" di mana pun posisinya, akan muncul!
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="bg-canvas border-4 border-black shadow-neo-xl p-6 md:p-12 rotate-1 hover:rotate-0 transition-transform">
              ...
              <p className="text-lg md:text-xl font-bold text-forest-teal mb-8 bg-white p-4 border-4 border-black shadow-neo-sm">
                Kadang satu syarat tidak cukup. Kamu butuh siswa yang "Tinggal di Bandung <strong>DAN</strong> umurnya 17 tahun", atau "Beli Baju <strong>ATAU</strong> Celana".
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white border-4 border-black p-6 shadow-neo-md hover:-translate-y-2 transition-transform">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="bg-black text-white px-3 py-1 font-black uppercase border-2 border-white text-sm">Semua Wajib</span>
                  </div>
                  ...
                  <p className="font-bold text-forest-teal">Data hanya muncul jika <strong>KEDUA</strong> syarat tersebut terpenuhi. Kurang satu saja, data tidak lolos.</p>
                </div>
                ...
                <div className="bg-white border-4 border-black p-6 shadow-neo-md hover:-translate-y-2 transition-transform">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="bg-mint-soft text-black px-3 py-1 font-black uppercase border-2 border-black text-sm">Bebas Pilih</span>
                  </div>
                  <div className="bg-black text-white font-mono p-4 border-2 border-black text-sm mb-4">
                    <span className="text-yellow-400">WHERE</span> kota = <span className="text-jade-vibrant">'Bandung'</span> <br/>
                    <span className="text-pink-400 font-black text-lg">OR</span> kota = <span className="text-jade-vibrant">'Jakarta'</span>;
                  </div>
                  <p className="font-bold text-forest-teal">Data akan muncul jika <strong>SALAH SATU</strong> syarat terpenuhi. Cocok untuk mencari pilihan lebih dari satu.</p>
                </div>
              </div>
            </section>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-canvas border-4 border-black p-6 shadow-neo-md flex flex-col md:flex-row items-center gap-6 hover:translate-x-2 transition-transform">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-black uppercase mb-2 text-forest-teal">Order By (Sorting)</h3>
                    <p className="font-bold text-lg text-black mb-2">Mengurutkan data yang berantakan.</p>
                    <ul className="list-disc pl-5 font-bold text-forest-teal text-sm mb-3">
                      <li><code>ASC</code> (Ascending): Dari terkecil ke terbesar / A ke Z (Otomatis).</li>
                ...
                <div className="bg-[#FFD700] border-4 border-black p-6 shadow-neo-md flex flex-col md:flex-row items-center gap-6 hover:translate-x-2 transition-transform">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-2">
                      <h3 className="text-2xl font-black uppercase text-black">Limit (Batas Limit)</h3>
                      <span className="bg-black text-white font-black text-xs uppercase px-2 py-1 animate-pulse">Penting!</span>
                    </div>
                    <p className="font-bold text-lg text-black mb-2">Hanya menampilkan sekian data teratas. Sangat berguna untuk menghemat kuota internet dan membuat sistem Pagination (Halaman 1, 2, 3).</p>
                    <code className="bg-white font-black px-3 py-1 border-2 border-black">LIMIT 5</code> <span className="font-bold text-sm ml-2">{"->"} Hanya tampilkan 5 data!</span>
                  </div>
                </div>
